        ...
        body: Builder(
          ...
          child: Card(
            ...
            child: ListTile(
              ...
              subtitle: Text('Price: \$${food[index].price.toStringAsFixed(2)}\n${food[index].des}'),
              isThreeLine: true,
              onTap: (){
                valueSetter(food[index]);
                Scaffold.of(context).showSnackBar(SnackBar(content: Text('Food has been added to cart!'),duration: const Duration(seconds: 1)));
                },
              ),
            ),
          );
